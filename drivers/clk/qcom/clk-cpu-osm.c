...
DEFINE_CLK_VOTER_NOCACHE(l3_cluster0_vote_clk, l3_clk, 0);
DEFINE_CLK_VOTER_NOCACHE(l3_cluster1_vote_clk, l3_clk, 0);
DEFINE_CLK_VOTER_NOCACHE(l3_misc_vote_clk, l3_clk, 0);
